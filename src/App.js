...
function App() {
  return (
    <Switch>
      ...
      <Route exact path="/explorar/comidas/ingredientes" component={ FoodIngredientsExp } />
      <Route exact path="/explorar/bebidas/ingredientes" component={ DrinkIngredientsExp } />
