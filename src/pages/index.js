...
export { default as FoodDetailPage } from './FoodDetailsPage';
export { default as FoodDetailInProgressPage } from './FoodDetailInProgressPage';
export { default as DrinksPage } from './DrinksPage';
export { default as DrinkDetailInProgressPage } from './DrinkDetailInProgressPage';
export { default as DrinkDetailPage } from './DrinkDetailsPage';
