...
describe('Testa se possui footer nas páginas', () => {
  test('Testando as rotas', () => {
    ...
    // verifica se o footer não possui na pagina de Login
    ...
    // verifica se possui footer na pagina de Bebidas
    history.push('/bebidas');
    expect(history.location.pathname).toBe('/bebidas');
    expect(screen.queryByTestId('footer')).toBeInTheDocument();

    // verifica se o footer não possui na pagina de Detalhes de comidas
    history.push('/comidas/:id');
    expect(history.location.pathname).toBe('/comidas/:id');
    expect(screen.queryByTestId('footer')).toBeNull();

    // verifica se o footer não possui na pagina de Detalhes de Bebidas
    history.push('/bebidas/:id');
    expect(history.location.pathname).toBe('/bebidas/:id');
    expect(screen.queryByTestId('footer')).toBeNull();

    // verifica se o footer não possui na pagina de Receitas de comidas em progresso
    ...
    // verifica se possui footer na pagina de Explorar
    history.push('/explorar');
    expect(history.location.pathname).toBe('/explorar');
    expect(screen.queryByTestId('footer')).toBeInTheDocument();

    // verifica se possui footer na pagina de Explorar Comidas
    history.push('/explorar/comidas');
    expect(history.location.pathname).toBe('/explorar/comidas');
    expect(screen.queryByTestId('footer')).toBeInTheDocument();

    // verifica se possui footer na pagina de Explorar Bebidas
    history.push('/explorar/bebidas');
    expect(history.location.pathname).toBe('/explorar/bebidas');
    expect(screen.queryByTestId('footer')).toBeInTheDocument();

    // verifica se possui footer na pagina de Explorar Comidas por ingredientes
    history.push('/explorar/comidas/ingredientes');
    expect(history.location.pathname).toBe('/explorar/comidas/ingredientes');
    expect(screen.queryByTestId('footer')).toBeInTheDocument();

    // verifica se possui footer na pagina de Explorar Bebidas por ingredientes
    history.push('/explorar/bebidas/ingredientes');
    expect(history.location.pathname).toBe('/explorar/bebidas/ingredientes');
    expect(screen.queryByTestId('footer')).toBeInTheDocument();

    // verifica se possui footer na pagina de Explorar comidas por local
    history.push('/explorar/comidas/area');
    expect(history.location.pathname).toBe('/explorar/comidas/area');
    expect(screen.queryByTestId('footer')).toBeInTheDocument();

    // verifica se possui footer na pagina de Perfil
    history.push('/perfil');
    expect(history.location.pathname).toBe('/perfil');
    expect(screen.queryByTestId('footer')).toBeInTheDocument();

    // verifica se o footer não possui na pagina de Receitas favoritas
    history.push('/receitas-favoritas');
    expect(history.location.pathname).toBe('/receitas-favoritas');
    expect(screen.queryByTestId('footer')).toBeNull();

    // verifica se o footer não possui na pagina de Receitas feitas
